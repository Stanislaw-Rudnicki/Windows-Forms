    ...
    int nCmdShow)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_WF014T01));
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    static HWND hButton[17], hEdit, hBack, hListBox;
    PAINTSTRUCT ps;
    HDC hdc;
    int i = 0;
    int count = 0, a = 0, b = 0;
    ...
    {
    case WM_CREATE:
        hBack = CreateWindow(_T("Static"), _T(""), WS_CHILD | WS_VISIBLE | WS_BORDER | ES_RIGHT, 11, 5, 228, 35, hWnd, (HMENU)ID_EDIT, hInst, 0);
        hEdit = CreateWindow(_T("Edit"), _T("0"), WS_CHILD | WS_VISIBLE | ES_READONLY | ES_RIGHT, 15, 10, 220, 25, hWnd, (HMENU)ID_EDIT, hInst, 0);
        GetObject(GetStockObject(DEFAULT_GUI_FONT), sizeof(LOGFONT), &lf);
        hFont = CreateFont(26, lf.lfWidth,
            lf.lfEscapement, lf.lfOrientation, FW_NORMAL,
        ...
        hButton[16] = CreateWindow(_T("Button"), _T("."), WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, 100, 150, 40, 30, hWnd, (HMENU)ID_BUTTON_POINT, hInst, 0);
        break;
    case WM_COMMAND:
